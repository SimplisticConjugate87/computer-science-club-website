       ...
       <h1 id ="WelcomeName"> Welcome To Los Medanoss Computer Scinece Club</h1>
        ...
        <img id="COMSCIIMAGEE" alt = "COMSCI CLUB IMAGE"  src = {logo}/>
         <p id = "AboutClub">We are  a computer science club that helps others foster their love through coding; anyone with an interest in computers is welcome. We have collabarative projects we do, guest speakers, 
            computer programming conferences/events (you can check any upcoming event here). Feel free to join or drop by share your projects/ideas to this club! Or really anything! Club meetings happen every Friday on our Discord!</p>
            </div>
           <div id="DiscordDiv">
            <h1>JOIN</h1>
